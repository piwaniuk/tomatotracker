...
static inline void iter_ordered_find(
    BidirectionalIterator* iter, void* value, char cmp(void* v1, void* v2)) {
  while (!iter_is_end(iter) && cmp(value, iter_get(iter)) < 0)
    iter_next(iter);
}
...
static inline bool ordered_list_insert_unique(
    LinkedList* list, void* value, char cmp(void* v1, void* v2)) {
